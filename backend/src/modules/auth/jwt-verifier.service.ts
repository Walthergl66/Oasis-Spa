 ...
 * publica la clave pública en un JWKS. Por eso el backend verifica con esa clave
 ...
 *
 * Se conserva soporte para HS256 porque los proyectos de Supabase creados antes
 * del cambio —y algunas instalaciones autoalojadas— siguen firmando con el
 * secreto compartido. La rama se decide leyendo el algoritmo de la cabecera.
 */
@Injectable()
